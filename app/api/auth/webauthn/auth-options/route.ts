...
export async function POST(req: NextRequest) {
  // If email is provided, look up that user's credentials so we can target their
  // specific authenticator — this prevents the cross-device QR code from appearing.
